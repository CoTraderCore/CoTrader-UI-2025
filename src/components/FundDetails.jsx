        ...
        <div className="space-y-6">
          ...
          <div className={`p-6 rounded-2xl border ${
            ...
            <div className="space-y-3">
              ...
              <button className="w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white py-3 rounded-xl font-medium hover:from-blue-600 hover:to-purple-700 transition-all duration-200 shadow-lg hover:shadow-xl">
                Claim Rewards
              </button>
            </div>
          </div>
